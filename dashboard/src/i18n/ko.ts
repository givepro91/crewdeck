const ko = {
  ...
  addGoalMaterialHelp: "미리 준비한 자료(기획 메모·PRD·요구사항 MD 등)를 붙여넣으면 AI가 분석해 목표로 분해하고, 각 목표의 기획서를 이 자료를 근거로 생성합니다.",
  addGoalMaterialPlaceholder: "여기에 준비한 자료를 붙여넣으세요 (Markdown 권장)…",
