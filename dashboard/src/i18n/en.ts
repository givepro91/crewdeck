const en = {
  ...
  addGoalMaterialHelp: "Paste material you've already prepared (planning notes, a PRD, requirements MD, etc.). The AI analyzes it, decomposes it into goals, and generates each goal's spec grounded in this material.",
  addGoalMaterialPlaceholder: "Paste your prepared material here (Markdown recommended)…",
